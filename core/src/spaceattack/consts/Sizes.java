...
public class Sizes {
    ...
    public static final float GAME_WIDTH = Gdx.graphics == null ? 720 * 0.75f : Gdx.graphics.getWidth();
    public static final float GAME_HEIGHT = Gdx.graphics == null ? 1280 * 0.75f : Gdx.graphics.getHeight();
