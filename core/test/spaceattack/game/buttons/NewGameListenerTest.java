...
public class NewGameListenerTest
{
	...
	public void ifFileExistsDoConfirm()
	{
		...
		verify(utils).confirmDialog(anyString(), anyString(), nullable(IStage.class));
	}
	...
	{
		doReturn(true).when(loader).fileExists();
		doReturn(true).when(utils).confirmDialog(anyString(), anyString(), nullable(IStage.class));
	...
	{
		doReturn(true).when(loader).fileExists();
		doReturn(false).when(utils).confirmDialog(anyString(), anyString(), nullable(IStage.class));
